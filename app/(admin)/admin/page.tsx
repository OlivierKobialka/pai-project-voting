...
export default function Admin() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100">
            ...
            <form className="space-y-4 w-full max-w-lg p-5 bg-white shadow-lg rounded-lg" onSubmit={handleAddGame}>
                <input
                    type="text"
                ...
                <input
                    ...
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setGameDescription(e.target.value)}
                    className="input w-full p-2 border rounded text-black"
                />
                <input
                    type="text"
                    placeholder="Link do zdjęcia gry"
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setGameBanner(e.target.value)}
                    className="input w-full p-2 border rounded text-black"
                />
                <input
                    type="text"
                    placeholder="Strona gry"
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setGamePage(e.target.value)}
                    className="input w-full p-2 border rounded text-black"
                />
                <input
                    type="text"
                    placeholder="Typ gry"
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setGameType(e.target.value)}
                    className="input w-full p-2 border rounded text-black"
                />
                <input
                    type="date"
                    onChange={(e: ChangeEvent<HTMLInputElement>) => setGameReleaseDate(e.target.value)}
                    className="input w-full p-2 border rounded text-black"
                />
                <button
                    type="submit"
